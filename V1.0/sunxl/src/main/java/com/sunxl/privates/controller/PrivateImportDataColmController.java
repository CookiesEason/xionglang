...
public class PrivateImportDataColmController {
	...
	public String goImportDataColm(HttpServletRequest request) {
		...
		try {
			PrivateBaseMethodUtil.goObjectViewList(request, searchParamList, "/private/importDataColm", Page.create(), "#idImportDataColmForm", PrivateImportDataColmController.OBJECTINFO);
