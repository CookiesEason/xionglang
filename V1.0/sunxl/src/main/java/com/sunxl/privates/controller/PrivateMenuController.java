...
public class PrivateMenuController {
	...
	public String goMenu(HttpServletRequest request) {
		...
		try {
			PrivateBaseMethodUtil.goObjectViewList(request, searchParamList, "/private/menu", Page.create(), "#idMenuForm", PrivateMenuController.OBJECTINFO, "刷新缓存和Session", "/initData/refreshData");
