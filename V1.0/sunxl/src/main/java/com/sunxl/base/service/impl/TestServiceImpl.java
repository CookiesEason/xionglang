...
public class TestServiceImpl extends GenericServiceImpl<Test> implements TestService {
	...
	@Override
	@Transactional
	public Test create(Test entity,Object... params) {
		return testDao.create(entity);
	}

	@Override
	@Transactional
	public void delete(Test entity,Object... params) {
		testDao.delete(entity.getId());
	}

	@Override
	@Transactional
	public Test update(Test entity,Object... params) {
