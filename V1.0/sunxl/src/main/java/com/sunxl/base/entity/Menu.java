...
public class Menu implements Serializable, Comparable<Menu> {
	...
	@Id
	@TableGenerator(name = "Menus", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.Menus", allocationSize = 1, initialValue = 0)
