...
public class ExportToExportInfo implements Serializable {
	...
	@Id
	@TableGenerator(name = "ExportToExportInfo", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.ExportToExportInfo", allocationSize = 1, initialValue = 0)
