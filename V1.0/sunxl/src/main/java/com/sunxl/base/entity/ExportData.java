...
public class ExportData implements Serializable {
	...
	@Id
	@TableGenerator(name = "ExportData", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.ExportData", allocationSize = 1, initialValue = 0)
