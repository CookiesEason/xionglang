...
public class Dept implements Serializable {
	...
	@Id
	@TableGenerator(name = "Dept", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.Dept", allocationSize = 1, initialValue = 0)
