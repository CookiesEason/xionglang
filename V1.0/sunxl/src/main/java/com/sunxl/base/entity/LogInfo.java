...
import com.sunxl.base.enums.LogType;
...
public class LogInfo implements Serializable {
	...
	@Id
	@TableGenerator(name = "LogInfo", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.LogInfo", allocationSize = 1, initialValue = 0)
