...
public class ImportToImportInfo implements Serializable {
	...
	@Id
	@TableGenerator(name = "ImportToImportInfo", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.ImportToImportInfo", allocationSize = 1, initialValue = 0)
