...
public class MenuToRole implements Serializable {
	...
	@Id
	@TableGenerator(name = "MenuToRole", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.MenuToRole", allocationSize = 1, initialValue = 0)
