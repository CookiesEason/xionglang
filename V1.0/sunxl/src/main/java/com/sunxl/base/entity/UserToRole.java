...
public class UserToRole implements Serializable {
	...
	@Id
	@TableGenerator(name = "UserToRole", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.UserToRole", allocationSize = 1, initialValue = 0)
