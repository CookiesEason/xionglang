...
public class AdminUser implements Serializable {
	...
	@Id
	@TableGenerator(name = "AdminUser", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.sunxl.base.entity.AdminUser", allocationSize = 1, initialValue = 0)
