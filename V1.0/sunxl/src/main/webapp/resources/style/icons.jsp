...
<body>
	<table class="table" style="width: 100%;">
		<tr>
			...
			<td><input name="r" value="ext-icon-asterisk_orange"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-asterisk_yellow"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-building_delete"
				type="radio" /></td>
		</tr>
		<tr>
			...
			<td><input name="r" value="ext-icon-bullet_arrow_bottom"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-bullet_arrow_down"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-bullet_arrow_top"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-bullet_arrow_up"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-bullet_toggle_minus"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-bullet_toggle_plus"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-comments_delete"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-computer_delete"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-contrast_decrease"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-contrast_high" type="radio" /></td>
			<td><input name="r" value="ext-icon-contrast_increase"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-controller_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-controller_error"
				type="radio" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-database_connect"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-database_delete"
				type="radio" /></td>
		</tr>
		<tr>
			...
			<td><input name="r" value="ext-icon-database_lightning"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-database_link" type="radio" /></td>
			<td><input name="r" value="ext-icon-database_refresh"
				type="radio" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-emoticon_evilgrin"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-emoticon_surprised"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-emoticon_tongue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-emoticon_unhappy"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-hourglass_delete"
				type="radio" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-joystick_delete"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-lightbulb_delete"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-lightning_delete"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-medal_bronze_add"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-medal_bronze_delete"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-medal_gold_delete"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-medal_silver_add"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-medal_silver_delete"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-plugin_disabled"
				type="radio" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-server_compressed"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-server_connect" type="radio" /></td>
			<td><input name="r" value="ext-icon-server_database"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-server_lightning"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-server_link" type="radio" /></td>
			<td><input name="r" value="ext-icon-server_uncompressed"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shading" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-shape_align_bottom"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_align_center"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_align_left"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_align_middle"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_align_right"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_align_top"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_flip_horizontal"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_flip_vertical"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-shape_group" type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_handles" type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_move_back"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_move_backwards"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_move_forwards"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_move_front"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_rotate_anticlockwise"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_rotate_clockwise"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-shape_square" type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_add"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_edit"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_go"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_key"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-shape_square_link"
				type="radio" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-sport_basketball"
				type="radio" /></td>
		</tr>
		<tr>
			...
			<td><input name="r" value="ext-icon-sport_shuttlecock"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-telephone_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-telephone_edit" type="radio" /></td>
			<td><input name="r" value="ext-icon-telephone_error"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-textfield_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-textfield_key" type="radio" /></td>
			<td><input name="r" value="ext-icon-textfield_rename"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_align_center"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_align_justify"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_align_left"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-text_align_right"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-text_horizontalrule"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_indent" type="radio" /></td>
			<td><input name="r" value="ext-icon-text_indent_remove"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_italic" type="radio" /></td>
			<td><input name="r" value="ext-icon-text_kerning" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-text_letterspacing"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_letter_omega"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_linespacing"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_list_bullets"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_list_numbers"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_lowercase" type="radio" /></td>
			<td><input name="r" value="ext-icon-text_padding_bottom"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_padding_left"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-text_padding_right"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_padding_top"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-text_strikethrough"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-text_subscript" type="radio" /></td>
			<td><input name="r" value="ext-icon-text_superscript"
				type="radio" /></td>
		</tr>
		<tr>
			...
			<td><input name="r" value="ext-icon-timeline_marker"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-transmit_delete"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-weather_lightning"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-application_add"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_cascade"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_double"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_edit"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_form"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_form_add"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-application_form_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_form_edit"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_form_magnify"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_get"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_go" type="radio" /></td>
			<td><input name="r" value="ext-icon-application_home"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_key"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_lightning"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-application_link"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_osx"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_osx_terminal"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_put"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_side_boxes"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_side_contract"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_side_expand"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_side_list"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-application_side_tree"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_split"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_tile_horizontal"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_tile_vertical"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_view_columns"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_view_detail"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_view_gallery"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_view_icons"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-application_view_list"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_view_tile"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-application_xp" type="radio" /></td>
			<td><input name="r" value="ext-icon-application_xp_terminal"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-arrow_refresh_small"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-arrow_rotate_anticlockwise"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-arrow_rotate_clockwise"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-arrow_switch" type="radio" /></td>
			<td><input name="r" value="ext-icon-arrow_turn_left"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-arrow_turn_right"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-award_star_bronze_1"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_bronze_2"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_bronze_3"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_gold_1"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-award_star_gold_2"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_gold_3"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_silver_1"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_silver_2"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-award_star_silver_3"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-calculator_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-calculator_edit"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-calculator_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-calculator_link"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar" type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar_add" type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar_edit" type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar_link" type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar_view_day"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-calendar_view_month"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-calendar_view_week"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-chart_bar_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_bar_edit" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-chart_bar_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_bar_link" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_curve" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_curve_add"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_curve_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_curve_edit"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_curve_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_curve_go" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-chart_curve_link"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_line" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_line_add" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_line_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_line_edit"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_line_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_line_link"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_organisation"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-chart_organisation_add"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_organisation_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_pie" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_pie_add" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_pie_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_pie_edit" type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_pie_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-chart_pie_link" type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-control_eject" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_eject_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_end" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_end_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_equalizer"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_equalizer_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_fastforward"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_fastforward_blue"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-control_pause" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_pause_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_play" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_play_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_repeat" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_repeat_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_rewind" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_rewind_blue"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-control_start" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_start_blue"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-control_stop" type="radio" /></td>
			<td><input name="r" value="ext-icon-control_stop_blue"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-email_open_image"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-folder_database"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-folder_lightbulb"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-folder_page_white"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-ipod_cast_delete"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-keyboard_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-keyboard_magnify"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-magifier_zoom_out"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-magnifier" type="radio" /></td>
			<td><input name="r" value="ext-icon-magnifier_zoom_in"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-monitor_lightning"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-newspaper_delete"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-page_paintbrush"
				type="radio" /></td>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-page_white_acrobat"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_actionscript"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_add" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_c" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_camera"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_cd" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_code"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-page_white_code_red"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_coldfusion"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_compressed"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_copy"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_cplusplus"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_csharp"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_cup" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_database"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-page_white_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_dvd" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_edit"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_error"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_excel"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_find"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_flash"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_freehand"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-page_white_gear"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-page_white_horizontal"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_key" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_lightning"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_link"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-page_white_magnify"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_medal"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_office"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_paint"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_paintbrush"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_paste"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_php" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_picture"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-page_white_powerpoint"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_put" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_ruby"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_stack"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_star"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_swoosh"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_text"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_text_width"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-page_white_tux" type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_vector"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_visualstudio"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_width"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_word"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_world"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-page_white_wrench"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-script_code_red"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-script_lightning"
				type="radio" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="r" value="ext-icon-table_lightning"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-table_relationship"
				type="radio" /></td>
		</tr>
		<tr>
			<td><input name="r" value="ext-icon-table_row_delete"
				type="radio" /></td>
			<td><input name="r" value="ext-icon-table_row_insert"
				type="radio" /></td>
			...
			<td><input name="r" value="ext-icon-tag_blue_delete"
				type="radio" /></td>
		...
		<tr>
			<td><input name="r" value="ext-icon-television_delete"
				type="radio" /></td>
