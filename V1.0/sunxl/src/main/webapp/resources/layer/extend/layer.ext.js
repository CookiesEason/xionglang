...
layer.photos = function(options){
    ...
    var conf = {
        ...
        bgcolor: '',
        page: {
            html: '<div class="xubox_bigimg"><div id="viewer2" class="viewer"></div><img id="layer_photo_img" src="'+getBasePath()+"/showImage/"+ log.thissrc +'" alt="'+ (log.name || '') +'" layer-pid="'+ (log.pid || '') +'"><div class="xubox_imgsee">'+ function(){
                if(log.imgLen > 1){
    ...
    log.event = function(){
        ...
        log.tabimg = function(){
            ...
            if(json){
                ...
                //src = nowdata.src;
                src = getBasePath()+"/showImage/"+nowdata.src;
                pid = nowdata.pid;
                name = nowdata.name;
            } else {
