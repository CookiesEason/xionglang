	...
	<fieldset>
		...
		<table class="table" id="normortable">
			<tr>
				...
				<td>
					<input value="${role.tableName}" name="tableName" data-options="required:true"
			...
			<tr>
				<th>类路径</th>
				<td>
					<input value="${role.entityKey}" name="entityKey" data-options="required:true"
						class="easyui-validatebox" />
				</td>
			</tr>
			<tr>
				<th>主键值</th>
				<td>
					<input value="${role.entityValue}" name="entityValue" data-options="required:true"
						class="easyui-validatebox" />
				</td>
			</tr>
			<tr>
				...
				<td>
					<textarea name="smrytx" class="easyui-validatebox" style="height: 100px; width: 90%;"
						data-options="required:true">${role.smrytx}</textarea>
				</td>
			</tr>
			<tr>
				<th>表创立时间</th>
				<td>
					<input name="createTime" value="${role.createTime}" class="Wdate easyui-validatebox"
