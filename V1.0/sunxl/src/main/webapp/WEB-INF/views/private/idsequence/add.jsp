	...
	<fieldset>
		...
		<table class="table" id="normortable">
			...
			<tr>
				<th>类路径</th>
				<td>
					<input name="entityKey" data-options="required:true" class="easyui-validatebox" />
				</td>
			</tr>
			<tr>
				<th>主键值</th>
				<td>
					<input name="entityValue" data-options="required:true" class="easyui-validatebox" />
				</td>
			</tr>
			<tr>
				<th>表用途</th>
				<td>
					<textarea name="smrytx" class="easyui-validatebox" style="height: 100px; width: 90%;"
						data-options="required:true">${act.content }</textarea>
				</td>
			</tr>
			<tr>
				<th>表创立时间</th>
