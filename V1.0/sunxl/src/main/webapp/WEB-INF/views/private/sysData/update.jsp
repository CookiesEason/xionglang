	...
	<fieldset>
		...
		<table class="table" id="normortable">
			<tr>
				<th>
					系统来源
					<input type="hidden" value="${sysTidData.id}" name="id" />
				</th>
				<td>
					<input value="${sysTidData.name}" name="name" data-options="required:true"
			...
			<tr>
				<th>系统来源路径</th>
				<td>
					<input value="${sysTidData.url}" name="url" data-options="required:true"
						class="easyui-validatebox" />
				</td>
			</tr>
			<tr>
				<th>系统添加时间</th>
				<td>
					<input name="createTime" value="${sysTidData.createTime}" class="Wdate easyui-validatebox"
