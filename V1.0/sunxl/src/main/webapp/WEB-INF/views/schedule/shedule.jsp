...
TD{font-size:12px;}
table{border-collapse:collapse;border-top: 1px #8CB2E3 solid; border-left: 1px #8CB2E3 solid;}
</STYLE>
<script type="text/javascript">
var syschedule=syschedule || {};
syschedule.contextPath='<%=request.getContextPath()%>';
</script>