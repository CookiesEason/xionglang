...
%>
<form id="taskTypeForm" method="get" name="taskTypeForm" action="<%=request.getContextPath()%>/private/schedule/path">
...
<tr>
	<td>任务项(","分隔):</td><td colspan="3"><TEXTAREA rows="5" id="taskItems" name="taskItems" style="width:657"><%=taskItems%> </TEXTAREA></td>
</tr>
