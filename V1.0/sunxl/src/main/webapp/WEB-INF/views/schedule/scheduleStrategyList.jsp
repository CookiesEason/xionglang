...
<table id="contentTableStrateg">
	...
	%>
	<tr
		onclick="openDetail(this,'<%=scheduleStrategy.getStrategyName()%>')">
		<td><%=(i + 1)%></td>
		<%
			if ("true".equals(isManager)) {
		%>
		<td width="100" align="center"><a target="strategyDetail"
			...
			style="color: #0000CD">编辑</a> <a target="strategyDetail"
			...
			style="color: #0000CD"><%=pauseOrResumeActionName%></a></td>
		<%
			}
		%>
