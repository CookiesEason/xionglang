...
%>
<iframe  name="content" style="height: 100%;width: 100%; border: 0;scroll: no;" src="<%=request.getContextPath()%>/private/schedule/path?path=private.schedule.scheduleStrategyList&manager=<%=isManager%>"></iframe>
<script>
