...
<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
	...
	%>
	<div data-options="iconCls:'ext-icon-user_edit'" onclick="changeRole('切换角色','${v_role}/1');">切换角色</div>
</div>
<div id="layout_north_zxMenu" style="width: 100px; display: none;">
	<div data-options="iconCls:'ext-icon-user_suit'" onclick="showMyInfoFun('/window/2','我的信息');">用户信息</div>
	<div data-options="iconCls:'ext-icon-lock'"
		onclick="lockWindowFun('#loginDialog','/window/3','#overlay');">锁定窗口</div>
	<div data-options="iconCls:'ext-icon-door_out'" onclick="logoutFun('/window/4','/admin/login');">退出系统</div>
</div>