...
public class ImportDataInfo implements Serializable {
	...
	@Id
	@TableGenerator(name = "ImportDataInfo", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.ImportDataInfo", allocationSize = 1, initialValue = 0)
