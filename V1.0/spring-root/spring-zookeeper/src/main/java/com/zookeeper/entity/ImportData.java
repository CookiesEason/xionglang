...
public class ImportData implements Serializable {
	...
	@Id
	@TableGenerator(name = "ImportData", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.ImportData", allocationSize = 1, initialValue = 0)
