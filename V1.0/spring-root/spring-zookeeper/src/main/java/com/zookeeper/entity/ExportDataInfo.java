...
public class ExportDataInfo implements Serializable {
	...
	@Id
	@TableGenerator(name = "ExportDataInfo", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.ExportDataInfo", allocationSize = 1, initialValue = 0)
