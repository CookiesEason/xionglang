...
<%@page import="com.base.one.entity.AdminUser"%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<%@include file="/WEB-INF/views/common/private/tags.jsp"%>
<%@include file="/WEB-INF/views/common/private/inc.jsp"%>
</head>
<body id="mainLayout" class="easyui-layout" style="font-size: 14px;">
	<div data-options="region:'north'"
		style="height: 99px; overflow: hidden;" class="logo">
	...
	<div data-options="region:'west',href:'',split:true" title="导航"
		...
		<div id="aa" class="easyui-accordion">
			<c:forEach items="${menuTree }" var="mTree">
				<div title="${mTree.name }"
					data-options="iconCls:'ext-icon-computer'" style="overflow: auto;">
						...
						<c:forEach items="${mTree.subMenus }" var="subTree">
							<li><a
								...
								id="a_corpor" style="text-decoration: none; color: black;">
									<span class="l-btn-text ext-icon-group l-btn-icon-left">&nbsp;&nbsp;&nbsp;&nbsp;
								</span> <span>${subTree.name }</span>
							</a></li>
						</c:forEach>
					</ul>
				</div>
	...
	<div data-options="region:'center'" style="overflow: hidden;">
		<div class="easyui-tabs" id="div_tabs">
			<div title="欢迎您！" style="padding: 20px;">
				...
				<div
					style="background: #fafafa; padding: 5px; width: 200px; border: 1px solid #ccc">
					<a href="#" class="easyui-menubutton" menu="#mm1"
						iconCls="ext-icon-arrow_switch">快捷通道</a>
				</div>
