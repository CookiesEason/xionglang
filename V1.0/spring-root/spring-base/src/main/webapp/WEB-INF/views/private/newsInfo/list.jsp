...
$(function(){
	dataGrid.datagrid({
		columns:[[
			...
			{field:'asbstract',title:'文章摘要',width:150},
			{field:'type',title:'位置',width:80,sortable:true,formatter:function(value,row,index){
 				return value==null?"":value.typeName;
			}},
 			{field:'menuName',title:'文章所属模块',width:80},
 			{field:'status',title:'文章状态',width:80,sortable:true,formatter:function(value,row,index){
 				return value==null?"":value.typeName;
			}},
 			{field:'submitName',title:'文章提交员',width:80},
 			{field:'adminUserName',title:'文章审核员',width:80},
