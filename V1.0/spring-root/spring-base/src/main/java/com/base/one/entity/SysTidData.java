...
public class SysTidData implements Serializable {
	...
	@Id
	@TableGenerator(name = "SysTidData", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.SysTidData", allocationSize = 1, initialValue = 0)
