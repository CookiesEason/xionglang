...
public class TableInfoBeanForm {
	...
	public TableInfoBeanForm(String tbName,String... jndiNames) throws SQLException, ConnectionException {
		this.tableName = tbName.toUpperCase();
		ResultSet rs = null;
		try {
			DatabaseMetaData meta = SunxlConnectionFactory.getUserConnection(jndiNames).getMetaData();
