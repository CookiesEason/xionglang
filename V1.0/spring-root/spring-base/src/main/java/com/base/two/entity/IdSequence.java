...
public class IdSequence implements Serializable {
	...
	/** 主键 */
	@Id
	@TableGenerator(name = "IdSequence", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.two.entity.IdSequence", allocationSize = 1, initialValue = 0)
