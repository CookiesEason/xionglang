...
public class AdminUserToRole implements Serializable {
	...
	@Id
	@TableGenerator(name = "AdminUserToRole", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.AdminUserToRole", allocationSize = 1, initialValue = 0)
