...
public class CheckCode implements Serializable {
	...
	/** 主键 */
	@Id
	@TableGenerator(name = "CheckCode", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.CheckCode", allocationSize = 1, initialValue = 0)
	...
	private int status;//0未使用，1使用,2失效
