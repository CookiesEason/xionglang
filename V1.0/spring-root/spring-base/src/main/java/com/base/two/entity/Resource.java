...
public class Resource implements Serializable {
	...
	@Id
	@TableGenerator(name = "Resource", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.two.entity.Resource", allocationSize = 1, initialValue = 0)
