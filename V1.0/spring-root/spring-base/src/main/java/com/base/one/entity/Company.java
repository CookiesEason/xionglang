...
import com.base.enums.CorporationType;
...
public class Company implements Serializable {
	...
	/** 主键 */
	@Id
	@TableGenerator(name = "Company", table = "id_sequence", pkColumnName = "ID_KEY", valueColumnName = "VALUE", pkColumnValue = "com.base.one.entity.Company", allocationSize = 1, initialValue = 0)
